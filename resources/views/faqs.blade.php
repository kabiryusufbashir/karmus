        ...
        <div class="col-md-12 bg-white text-center">
            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    ...
                    <p class="text-left">
                        Don bincika kalma, kawai bincika mashin binciken a saman allo, shigar da kalmar kuma danna maɓallin bincike.
                    </p>
                    ...
                    <h4 class="text-left"><b>4.	Ta Yaya zan Tuntuɓi Kamus Dictionary?</b></h4>
                    <p class="text-left">
                        Don ƙarin tambayoyi, yi mana imel a:  <a href="mailto:info@kamusdictionary.com">info@kamusdictionary.com</a> 
                    </p>
                    
                    <h4 class="text-left"><b>5.	A Ina Zan Sami Karin Bayani game da Kundin ƙamus?</b></h4>
                    <p class="text-left">
